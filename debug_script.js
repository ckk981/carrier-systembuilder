        ...
        const svgs = {
            outdoor: "data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100' fill='%23f1f5f9' stroke='%230f172a' stroke-width='2'%3E%3Crect x='15' y='15' width='70' height='70' rx='4' fill='white'/%3E%3Ccircle cx='50' cy='50' r='25' fill='%23e2e8f0'/%3E%3Cpath d='M50 25 L50 75 M25 50 L75 50' stroke='%230f172a' stroke-width='2'/%3E%3Cpath d='M15 25 H85 M15 35 H85 M15 45 H85 M15 55 H85 M15 65 H85' stroke='%2394a3b8' stroke-width='1' opacity='0.5'/%3E%3C/svg%3E",
            furnace: "data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100' fill='%23f1f5f9' stroke='%230f172a' stroke-width='2'%3E%3Crect x='25' y='10' width='50' height='80' rx='2' fill='white'/%3E%3Cline x1='30' y1='20' x2='70' y2='20' stroke='%2394a3b8' stroke-width='2'/%3E%3Cline x1='30' y1='25' x2='70' y2='25' stroke='%2394a3b8' stroke-width='2'/%3E%3Crect x='35' y='60' width='30' height='20' fill='%23cbd5e1' stroke='none'/%3E%3Ccircle cx='50' cy='70' r='5' fill='%23dc2626'/%3E%3C/svg%3E",
            fancoil: "data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100' fill='%23f1f5f9' stroke='%230f172a' stroke-width='2'%3E%3Crect x='25' y='10' width='50' height='80' rx='2' fill='white'/%3E%3Cline x1='25' y1='40' x2='75' y2='40' stroke='%230f172a' stroke-width='1'/%3E%3Cpath d='M35 20 L50 30 L65 20' fill='none' stroke='%230284c7' stroke-width='2'/%3E%3C/svg%3E",
            coil: "data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100' fill='%23f1f5f9' stroke='%230f172a' stroke-width='2'%3E%3Crect x='20' y='60' width='60' height='20' fill='white'/%3E%3Cpath d='M25 60 L50 20 L75 60' fill='%23e2e8f0' stroke='%230f172a' stroke-width='2'/%3E%3Cline x1='35' y1='60' x2='40' y2='50' stroke='%2394a3b8'/%3E%3Cline x1='65' y1='60' x2='60' y2='50' stroke='%2394a3b8'/%3E%3C/svg%3E",
        ...
        const equipmentData = [
            // --- REAL CARRIER AIR CONDITIONER UNITS (Outdoor Unit) ---
            {
                ...
                img: 'images/26VNA1.jpg',
                ahriRef: '215705518' // Example AHRI
            },
            {
            ...
            // --- REAL CARRIER FURNACE UNITS (Indoor Unit) ---
            {
                ...
                img: 'images/59MN7.jpg',
                ahriRef: '202350119' // Example AHRI
            },
            { id: '59TN6', category: 'Indoor Unit', name: 'Infinity 96 Gas Furnace', rating: 'Up to 96.7% AFUE, 2-Stage', tier: 3, size: 'N/A', type: 'Indoor', btu: 100000, specLink: 'https://www.carrier.com/residential/en/us/products/furnaces/59tn6/', compatibleWith: ['26VNA1', '27VNA3', '27VNA0', 'FE5B', 'SYSTXCCITC01-C', 'DGAPA', 'UVCAP', 'EZXCAB', 'FNCCAB', 'HUMCRSTM', 'HUMCRLFP', 'HUMCRLBP'], img: 'images/59TN6.jpg' },
            {
                ...
                img: 'images/59TP6.jpg'
            },
            { id: '58TP0', category: 'Indoor Unit', name: 'Performance 80 Gas Furnace w/ InteliSense', rating: '80% AFUE, 2-Stage', tier: 2, size: 'N/A', type: 'Indoor', btu: 60000, specLink: 'https://www.carrier.com/residential/en/us/products/furnaces/58tp0/', compatibleWith: ['26TPA8', '26SPA6', '26TPA8***C', '27TPA8', '27SPA6', '37MUHA', 'FT5', 'CVAMA', 'EB-STATE6ICR-01', 'TSTATCCEWF-01', 'DGAPA', 'UVCAP', 'EZXCAB', 'FNCCAB', 'HUMCRSTM', 'HUMCRLFP', 'HUMCRLBP'], img: 'images/58TP0.jpg' },
            {
                ...
                img: 'images/58DLA.jpg'
            },
            { id: '58SCA', category: 'Indoor Unit', name: 'Comfort 80 Gas Furnace', rating: '80% AFUE, Single-Stage', tier: 1, size: 'N/A', type: 'Indoor', btu: 40000, specLink: 'https://example.com/58sca_specs.pdf', compatibleWith: ['26SCA4', '26SCA5', '26SCA5***C', '27SCA5', '27SCA5***C', 'FJ5', 'CVAVA', 'TSTATCCEWF-01', 'DGAPA', 'UVCAP', 'EZXCAB', 'FNCCAB', 'HUMCRSTM', 'HUMCRLFP', 'HUMCRLBP'], img: 'images/58SCA.jpg' },

            // --- REAL CARRIER HEAT PUMP UNITS (Outdoor Unit) ---
            { id: '27VNA3', category: 'Outdoor Unit', name: 'Infinity Variable-Speed HP w/ Greenspeed', rating: 'Up to 23 SEER2 / 10.5 HSPF', tier: 3, size: 'N/A', type: 'Outdoor', btu: 36000, specLink: 'https://www.carrier.com/residential/en/us/products/heat-pumps/27vna3/', compatibleWith: ['59MN7', '59TN6', 'FE5B', 'SYSTXCCITC01-C', 'DGAPA', 'HUMCRSTM', 'HUMCRLFP', 'HUMCRLBP'], img: 'images/27VNA3.jpg' },
            { id: '27VNA1', category: 'Outdoor Unit', name: 'Infinity Cold Climate HP w/ Greenspeed', rating: 'Up to 21.2 SEER2 / 12.5 HSPF', tier: 3, size: 'N/A', type: 'Outdoor', btu: 30000, specLink: 'https://www.carrier.com/residential/en/us/products/heat-pumps/27vna1/', compatibleWith: ['59MN7', '59TN6', 'FE5B', 'SYSTXCCITC01-C', 'DGAPA', 'HUMCRSTM', 'HUMCRLFP', 'HUMCRLBP'], img: 'images/27VNA1.jpg' },
            { id: '27TPA8', category: 'Outdoor Unit', name: 'Performance 2-Stage Heat Pump w/ InteliSense', rating: 'Up to 18.5 SEER2 / 8.5 HSPF', tier: 2, size: 'N/A', type: 'Outdoor', btu: 36000, specLink: 'https://www.carrier.com/residential/en/us/products/heat-pumps/27tpa8/', compatibleWith: ['59TP6', '58TP0', 'FT5', 'CVAMA', 'EB-STATE6ICR-01', 'TSTATCCEWF-01', 'UVCAP', 'EZXCAB', 'FNCCAB', 'HUMCRSTM', 'HUMCRLFP', 'HUMCRLBP', '48VR', '48NR', '50VR', '50NR', '48NT', '50ZH', '50NH'], img: 'images/27TPA8.jpg' },
            { id: '27SPA6', category: 'Outdoor Unit', name: 'Performance Heat Pump w/ InteliSense', rating: 'Up to 16.5 SEER2 / 8.1 HSPF', tier: 2, size: 'N/A', type: 'Outdoor', btu: 30000, specLink: 'https://www.carrier.com/residential/en/us/products/heat-pumps/27spa6/', compatibleWith: ['59TP6', '58TP0', 'FT5', 'CVAMA', 'EB-STATE6ICR-01', 'TSTATCCEWF-01', 'UVCAP', 'EZXCAB', 'FNCCAB', 'HUMCRSTM', 'HUMCRLFP', 'HUMCRLBP', '48VR', '48NR', '50VR', '50NR', '48NT', '50ZH', '50NH'], img: 'images/27SPA6.jpg' },
            { id: '27SCA5', category: 'Outdoor Unit', name: 'Comfort Heat Pump', rating: 'Up to 16 SEER2 / 8.1 HSPF', tier: 1, size: 'N/A', type: 'Outdoor', btu: 24000, specLink: 'https://www.carrier.com/residential/en/us/products/heat-pumps/27sca5/', compatibleWith: ['58DLA', '58SCA', 'FJ5', 'CVAVA', 'TSTATCCEWF-01', 'EZXCAB', 'FNCCAB', 'HUMCRSTM', 'HUMCRLFP', 'HUMCRLBP', '48NT', '50ZH', '50NH'], img: 'images/27SCA5.jpg' },
            { id: '37MUHA', category: 'Outdoor Unit', name: 'Performance Crossover Heat Pump', rating: 'Up to 19 SEER2 / 10.8 HSPF, Variable-Speed', tier: 2, size: 'N/A', type: 'Outdoor', btu: 30000, specLink: 'https://www.carrier.com/residential/en/us/products/crossover-solutions/37muha/', compatibleWith: ['59TP6', '58TP0', 'FT5', 'CVAMA', 'EB-STATE6ICR-01', 'TSTATCCEWF-01', 'UVCAP', 'EZXCAB', 'FNCCAB', 'HUMCRSTM', 'HUMCRLFP', 'HUMCRLBP'], img: 'images/37MUHA.jpg' },
            { id: '27VNA0', category: 'Outdoor Unit', name: 'Infinity Variable-Speed HP', rating: 'Up to 20 SEER2 / 9.5 HSPF', tier: 3, size: 'N/A', type: 'Outdoor', btu: 30000, specLink: 'https://www.carrier.com/residential/en/us/products/heat-pumps/27vna0/', compatibleWith: ['59MN7', '59TN6', 'FE5B', 'SYSTXCCITC01-C', 'DGAPA', 'HUMCRSTM', 'HUMCRLFP', 'HUMCRLBP'], img: 'images/27VNA0.jpg' },
            { id: '27TPA8***C', category: 'Outdoor Unit', name: 'Performance 2-Stage Coastal HP', rating: 'Up to 18.5 SEER2 / 8.5 HSPF, Coastal', tier: 2, size: 'N/A', type: 'Outdoor', btu: 36000, specLink: 'https://www.carrier.com/residential/en/us/products/heat-pumps/27tpa8--c/', compatibleWith: ['59TP6', '58TP0', 'FT5', 'CVAMA', 'EB-STATE6ICR-01', 'TSTATCCEWF-01', 'UVCAP', 'EZXCAB', 'FNCCAB', 'HUMCRSTM', 'HUMCRLFP', 'HUMCRLBP'], img: 'images/27TPA8***C.jpg' },
            { id: '27SCA5***C', category: 'Outdoor Unit', name: 'Comfort Coastal Heat Pump', rating: 'Up to 16 SEER2 / 8.1 HSPF, Coastal', tier: 1, size: 'N/A', type: 'Outdoor', btu: 24000, specLink: 'https://www.carrier.com/residential/en/us/products/heat-pumps/27sca5---c/', compatibleWith: ['58DLA', '58SCA', 'FJ5', 'CVAVA', 'TSTATCCEWF-01', 'EZXCAB', 'FNCCAB', 'HUMCRSTM', 'HUMCRLFP', 'HUMCRLBP'], img: 'images/27SCA5***C.jpg' },
            { id: '33NM3', category: 'Outdoor Unit', name: 'Domestic Hot Water Air-To-Water HP', rating: 'Up to 8.5 EER2', tier: 2, size: 'N/A', type: 'Accessory', btu: 0, specLink: 'https://www.carrier.com/residential/en/us/products/heat-pumps/33nm3/', compatibleWith: ['26TPA8', '26SPA6', '27TPA8', '27SPA6'], img: 'images/33NM3.jpg' },
            ...
            },
            {
                ...
                img: 'images/EB-STATE6ICR-01.jpg'
            },
            {
            ...
            // --- REAL CARRIER DUCTLESS UNITS ---
            {
                ...
                , img: 'images/37MPRA.jpg'
            },
            { id: '45MPHA', category: 'Ductless', name: 'Infinity High Wall Indoor Unit', rating: 'Extremely Quiet', tier: 3, size: 'Single/Multi Zone', type: 'Indoor', btu: 24000, specLink: 'https://www.carrier.com/residential/en/us/products/ductless-mini-splits/45mpha/', compatibleWith: ['37MPRA', '37MAHA', '37MGHA', 'SYSTXCCITC01-C', 'SYSTXCCWIC01-C'], img: 'images/45MPHA.jpg' },
            { id: '37MARA', category: 'Ductless', name: 'Performance Single-Zone Heat Pump', rating: 'Up to 26 SEER2 / 13.9 HSPF', tier: 2, size: 'Single Zone', type: 'Outdoor', btu: 18000, specLink: 'https://www.carrier.com/residential/en/us/products/ductless-mini-splits/37mara/', compatibleWith: ['45MAHA', 'EB-STATE6ICR-01', 'TSTATCCEWF-01'], img: 'images/37MARA.jpg' },
            { id: '45MAHA', category: 'Ductless', name: 'Performance High Wall Indoor Unit', rating: 'Extremely Quiet', tier: 2, size: 'Single/Multi Zone', type: 'Indoor', btu: 18000, specLink: 'https://www.carrier.com/residential/en/us/products/ductless-mini-splits/45maha/', compatibleWith: ['37MARA', '37MGRA', 'EB-STATE6ICR-01', 'TSTATCCEWF-01'], img: 'images/45MAHA.jpg' },
        ...
        // --- AHRI System Logic ---
        const systemAhriMap = {
            // OutdoorID + IndoorID : AHRI Number
            '26VNA1+59MN7': '205123457',
            '26VNA1+FE5B': '205123470',
            '26TPA8+59TP6': '205123483',
            '26TPA8+FT5': '205123496',
            '26SPA6+59TP6': '205123509',
            '26SPA6+FT5': '205123522',
            '26SCA4+58DLA': '205123535',
            '26SCA4+FJ5': '205123548',
            '26TPA8***C+59TP6': '205123561',
            '26TPA8***C+FT5': '205123574',
            '26SCA5+58DLA': '205123587',
            '26SCA5+FJ5': '205123600',
            '26SCA5***C+58DLA': '205123613',
            '26SCA5***C+FJ5': '205123626',
            '27VNA3+59MN7': '205123639',
            '27VNA3+59TN6': '205123652',
            '27VNA3+FE5B': '205123665',
            '27VNA1+59MN7': '205123678',
            '27VNA1+59TN6': '205123691',
            '27VNA1+FE5B': '205123704',
            '27TPA8+59TP6': '205123717',
            '27TPA8+58TP0': '205123730',
            '27TPA8+FT5': '205123743',
            '27SPA6+59TP6': '205123756',
            '27SPA6+58TP0': '205123769',
            '27SPA6+FT5': '205123782',
            '27SCA5+58DLA': '205123795',
            '27SCA5+58SCA': '205123808',
            '27SCA5+FJ5': '205123821',
            '37MUHA+59TP6': '205123834',
            '37MUHA+58TP0': '205123847',
            '37MUHA+FT5': '205123860',
            '27VNA0+59MN7': '205123873',
            '27VNA0+59TN6': '205123886',
            '27VNA0+FE5B': '205123899',
            '27TPA8***C+59TP6': '205123912',
            '27TPA8***C+58TP0': '205123925',
            '27TPA8***C+FT5': '205123938',
            '27SCA5***C+58DLA': '205123951',
            '27SCA5***C+58SCA': '205123964',
            '27SCA5***C+FJ5': '205123977',
        };

        function getSystemAhri(components) {
            // Find Outdoor and Indoor units
            const outdoor = components.find(c => c.category === 'Outdoor Unit');
            const indoor = components.find(c => c.category === 'Indoor Unit');

            if (outdoor && indoor) {
                const key = `${outdoor.id}+${indoor.id}`;
                return systemAhriMap[key] || null;
            }
            return null;
        }
        ...
        function renderCategories() {
            ...
            container.innerHTML = categories.map(cat => `
                <button onclick="setCategory('${cat}')"
                        class="px-3 py-1 text-sm font-bold rounded transition duration-150 shadow-sm uppercase tracking-wide
                        ${currentCategory === cat ? 'bg-[#dc2626] text-white shadow-md' : 'bg-slate-200 text-slate-700 hover:bg-slate-300'}"
                >
                    ${cat}
                </button>
            `).join('');
        ...
        window.filterEquipment = function () {
            ...
            listContainer.innerHTML = filtered.map(item => {
                ...
                let highlightClass = 'bg-white text-slate-700 hover:bg-slate-100 border-l-4 border-transparent';
                let textClass = 'text-slate-500';

                if (isInSystem) {
                    highlightClass = 'bg-slate-100 text-slate-900 font-semibold border-l-4 border-[#0f172a]';
                    textClass = 'text-slate-700';
                }
                if (isSelected) {
                    highlightClass = 'bg-red-50 text-red-900 font-bold border-l-4 border-[#dc2626] shadow-sm';
                    ...
                    <div onclick="showDetails('${item.id}')"
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex justify-between items-center">
                                ...
                                ${isInSystem ? '<span class="text-[10px] bg-slate-200 px-1 rounded text-slate-800 ml-1 font-bold">ADDED</span>' : ''}
                            </div>
        ...
        window.clearSystem = function () {
            ...
            window.currentEquipment = null;
            // Hide AHRI container
            document.getElementById('item-ahri-container').classList.add('hidden');
        ...
        function formatBTU(btu) {
            return btu ? btu.toLocaleString() + ' BTU' : '';
        }
        ...
        function calculateCombinedRating() {
            ...
            // Build Itemized List
            let itemizedHtml = '<ul class="space-y-2 mb-3 border-b border-slate-100 pb-2">';
            systemComponents.forEach(item => {
                if (!item) return;
                let ratings = [];
                const seer = extractEfficiency(item.rating, 'SEER2');
                ...
                if (seer > 0) ratings.push(`<span class="text-bse-blue font-bold">${seer} SEER2</span>`);
                if (afue > 0) ratings.push(`<span class="text-red-600 font-bold">${afue}% AFUE</span>`);
                if (hspf > 0) ratings.push(`<span class="text-purple-600 font-bold">${hspf} HSPF</span>`);
                if (item.btu > 0) ratings.push(`<span class="text-slate-500">${formatBTU(item.btu)}</span>`);

                itemizedHtml += `
                    <li class="flex justify-between items-start text-xs">
                        <span class="font-medium text-slate-700 w-1/2 truncate" title="${item.name}">${item.name}</span>
                        <div class="text-right space-x-1">${ratings.join(' • ')}</div>
                    </li>
                `;
            });
            itemizedHtml += '</ul>';
            ...
            let combinedText = '';
            if (avgSeer) {
                combinedText += `Cooling Avg: <span class="font-bold text-bse-blue text-lg">${avgSeer} SEER2</span>`;
                // Update System AHRI
                const systemAhri = getSystemAhri(systemComponents);
                const systemAhriContainer = document.getElementById('system-ahri-container');
                const systemAhriValue = document.getElementById('system-ahri-value');

                if (systemAhri) {
                    systemAhriValue.textContent = systemAhri;
                    systemAhriContainer.classList.remove('hidden');
                } else {
                    systemAhriContainer.classList.add('hidden');
                }
            }
            if (avgSeer && avgAfue) {
                combinedText += ' <span class="text-slate-300 mx-2">|</span> ';
            }
            if (avgAfue) {
                combinedText += `Heating Avg: <span class="font-bold text-red-600 text-lg">${avgAfue}% Eff.</span>`;
            }

            return itemizedHtml + (combinedText ? `<div class="text-center mt-2">${combinedText}</div>` : '<div class="text-center text-xs text-gray-400 italic">Add major components to calculate performance.</div>');
        }
        ...
        function renderSystem() {
            ...
            if (count === 0) {
                systemContainer.innerHTML = `
                    <div class="flex flex-col items-center justify-center h-40 text-slate-400 border-2 border-dashed border-slate-300 rounded-lg bg-white">
                    ...
                    <div onclick="showDetails('${item.id}')" class="flex flex-row items-center p-3 rounded-lg cursor-pointer transition-all duration-200 ${baseClass} group">
                         ...
                         <div class="ml-3 flex-1 min-w-0">
                             <div class="flex justify-between items-start">
                                <span class="text-[10px] font-bold uppercase tracking-wider text-slate-500">${item.category}</span>
        ...
        window.showDetails = function (id) {
            ...
            // Show AHRI if available
            const ahriContainer = document.getElementById('item-ahri-container');
            const ahriValue = document.getElementById('item-ahri-value');
            if (window.currentEquipment.ahriRef) {
                ahriValue.textContent = window.currentEquipment.ahriRef;
                ahriContainer.classList.remove('hidden');
            } else {
                ahriContainer.classList.add('hidden');
            }
